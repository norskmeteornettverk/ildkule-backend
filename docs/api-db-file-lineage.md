...
| Auth | `POST /api/auth/login` | `username` | `user.username` | - | request payload | lookup case-insensitive | direct | `fastapi_app/app/routers/auth.py:18`, `fastapi_app/app/services/user_service.py:30` |
...
| Auth | `POST /api/auth/login` response | `id`, `email`, `username`, `user_role`, `roles`, `user_level`, `tutorial_completed`, `confirmed` | `user.id`, `username`, `role`, `user_level`, `tutorial_completed`, `confirmed` | - | - | direkte/lett wrapper | direct | `fastapi_app/app/routers/auth.py:34` |
...
| User | `POST /api/users` | `username`, `password` | `user.username`, `user.password` | - | payload | password hashes foer lagring | direct | `fastapi_app/app/routers/users.py:18`, `fastapi_app/app/services/user_service.py:19` |
| User | `GET /api/users/{id}`, `/api/users`, `PATCH /api/users/{id}`, `PUT /api/users/{id}/tutorial-completion`, `PATCH /api/users/{id}/password` | `id`, `username`, `user_role`, `roles`, `user_level`, `tutorial_completed`, `confirmed` | `user.id`, `username`, `role`, `user_level`, `tutorial_completed`, `confirmed` | - | `serialize_user` wrapper | direct | `fastapi_app/app/utils/serialization.py:533` |
...
| Station log | `GET /api/station-logs` | `id`, `station_name`, `code`, `log_time`, `created_at` | `log_station.*` | - | - | direkte `model_to_dict` | direct | `fastapi_app/app/routers/logs.py:14`, `fastapi_app/app/models/log_station.py:11` |
