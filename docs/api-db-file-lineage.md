...
| Event | same | `final_classification` | `event.user_confirmed` | - | - | `1 -> Meteor`, `0 -> Ikke meteor`, ellers `Usikker` | derived | `fastapi_app/app/utils/serialization.py:319` |
...
| Res entries | `/api/event/{id}/res` | `resEntries[].long1`, `lat1`, `long2`, `lat2`, `height` | `event_res_entry.*` | `*.res` | tokens 1-5 paa raden | finnes i DB, men er ikke med i Pydantic response-modellen | db-only | `fastapi_app/app/services/file_mapper.py:337`, `fastapi_app/app/models/event_res_entry.py:22`, `fastapi_app/app/schemas/event.py:386` |
...
| Trail points | `/api/observation/{id}/trail` | `trailPoints[].gnomonic_x`, `gnomonic_y`, `brightness`, `dct`, `size`, `frame_brightness` | `observation_trail_point.*` | `event.txt` | `[trail]` arrays normalisert per frame | finnes i DB, men er ikke med i Pydantic response-modellen | db-only | `fastapi_app/app/models/observation_trail_point.py:33`, `fastapi_app/app/schemas/event.py:397` |
...
|---|---|---|---|
| `event` | `camera_confirmed`, `user_confirmed` | brukes som grunnlag for derived felter, men prunes bort i offentlig payload | `fastapi_app/app/utils/serialization.py:504`, `591` |
...
| `event_res_entry` | `long1`, `lat1`, `long2`, `lat2`, `height` | lagres i DB, men response-modellen eksponerer bare `id`, `line_no`, `entry_type`, `label`, `raw_line` | `fastapi_app/app/models/event_res_entry.py:22`, `fastapi_app/app/schemas/event.py:379` |
| `observation_trail_point` | `gnomonic_x`, `gnomonic_y`, `brightness`, `dct`, `size`, `frame_brightness` | lagres i DB, men response-modellen eksponerer bare et delsett | `fastapi_app/app/models/observation_trail_point.py:33`, `fastapi_app/app/schemas/event.py:397` |
...
| `station` | `id`, `station_name`, `created` | brukes bare indirekte via joins og `station_summary` | `fastapi_app/app/models/station.py:13` |
| `cam` | `id`, `station_id`, `cam_name`, `created` | brukes bare indirekte via observations og joins | `fastapi_app/app/models/cam.py:13` |
