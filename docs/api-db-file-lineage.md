...
| Tutorial | `GET /api/tutorial` | `title`, `intro`, `sections[].id`, `title`, `bullets[]` | - | - | statisk backend-innhold | egen innholdsflate for tutorial, atskilt fra statusflagget paa bruker | api-only | `fastapi_app/app/routers/users.py` |
