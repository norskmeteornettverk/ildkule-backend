...
class ComposerStaticInita9fbd799f4364206bd263db933a9c871
{
    ...
    public static $classMap = array (
        'AbstractController' => __DIR__ . '/../..' . '/api/src/controllers/resourcecontrollers/AbstractController.php',
        'Cam' => __DIR__ . '/../..' . '/api/src/models/Cam.php',
        'CamDao' => __DIR__ . '/../..' . '/api/src/dao/CamDao.php',
        'Composer\\InstalledVersions' => __DIR__ . '/..' . '/composer/InstalledVersions.php',
        'ContactController' => __DIR__ . '/../..' . '/api/src/controllers/resourcecontrollers/ContactController.php',
        'DaoInterface' => __DIR__ . '/../..' . '/api/src/dao/DaoInterface.php',
        'DataAccessHelper' => __DIR__ . '/../..' . '/api/src/helpers/DataAccessHelper.php',
        'DatabaseConnection' => __DIR__ . '/../..' . '/api/src/dao/DatabaseConnection.php',
        'FileLoadController' => __DIR__ . '/../..' . '/api/src/controllers/resourcecontrollers/FileLoadController.php',
        'FileToObjectMapper' => __DIR__ . '/../..' . '/api/src/mappers/FileToObjectMapper.php',
        'ImgHelper' => __DIR__ . '/../..' . '/api/src/mappers/ImgHelper.php',
        'InsightDashboardController' => __DIR__ . '/../..' . '/api/src/controllers/resourcecontrollers/InsightDashboardController.php',
        'LogService' => __DIR__ . '/../..' . '/api/src/service/LogService.php',
        'ManuaInputObservation' => __DIR__ . '/../..' . '/api/src/models/ManualInputObservation.php',
        'Meteor' => __DIR__ . '/../..' . '/api/src/models/Meteor.php',
        'MeteorAdminBoardController' => __DIR__ . '/../..' . '/api/src/controllers/resourcecontrollers/MeteorAdminBoardController.php',
        'MeteorClassificationController' => __DIR__ . '/../..' . '/api/src/controllers/resourcecontrollers/MeteorClassificationController.php',
        'MeteorDao' => __DIR__ . '/../..' . '/api/src/dao/MeteorDao.php',
        'MeteorService' => __DIR__ . '/../..' . '/api/src/service/MeteorService.php',
        'ObservationCamData' => __DIR__ . '/../..' . '/api/src/models/ObservationCamData.php',
        'ObservationCamDataDao' => __DIR__ . '/../..' . '/api/src/dao/ObservationCamDataDao.php',
        ...
        'Role' => __DIR__ . '/../..' . '/api/src/models/Role.php',
        'Router' => __DIR__ . '/../..' . '/api/src/controllers/Router.php',
        ...
        'Station' => __DIR__ . '/../..' . '/api/src/models/Station.php',
        'StationDao' => __DIR__ . '/../..' . '/api/src/dao/StationDao.php',
        'StationLogController' => __DIR__ . '/../..' . '/api/src/controllers/resourcecontrollers/StationLogController.php',
        ...
        'User' => __DIR__ . '/../..' . '/api/src/models/User.php',
        'UserController' => __DIR__ . '/../..' . '/api/src/controllers/resourcecontrollers/UserController.php',
        'UserDao' => __DIR__ . '/../..' . '/api/src/dao/UserDao.php',
        'UserListController' => __DIR__ . '/../..' . '/api/src/controllers/resourcecontrollers/UserDetailsController.php',
        'UserLoginController' => __DIR__ . '/../..' . '/api/src/controllers/resourcecontrollers/UserLoginController.php',
        'UserReview' => __DIR__ . '/../..' . '/api/src/models/UserReview.php',
        'UserReviewDao' => __DIR__ . '/../..' . '/api/src/dao/UserReviewDao.php',
        'UserService' => __DIR__ . '/../..' . '/api/src/service/UserService.php',
    );
