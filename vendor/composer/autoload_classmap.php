...
return array(
    'AbstractController' => $baseDir . '/api/src/controllers/resourcecontrollers/AbstractController.php',
    'Cam' => $baseDir . '/api/src/models/Cam.php',
    'CamDao' => $baseDir . '/api/src/dao/CamDao.php',
    'Composer\\InstalledVersions' => $vendorDir . '/composer/InstalledVersions.php',
    'ContactController' => $baseDir . '/api/src/controllers/resourcecontrollers/ContactController.php',
    'DaoInterface' => $baseDir . '/api/src/dao/DaoInterface.php',
    'DataAccessHelper' => $baseDir . '/api/src/helpers/DataAccessHelper.php',
    'DatabaseConnection' => $baseDir . '/api/src/dao/DatabaseConnection.php',
    'FileLoadController' => $baseDir . '/api/src/controllers/resourcecontrollers/FileLoadController.php',
    'FileToObjectMapper' => $baseDir . '/api/src/mappers/FileToObjectMapper.php',
    'ImgHelper' => $baseDir . '/api/src/mappers/ImgHelper.php',
    'InsightDashboardController' => $baseDir . '/api/src/controllers/resourcecontrollers/InsightDashboardController.php',
    'LogService' => $baseDir . '/api/src/service/LogService.php',
    'ManuaInputObservation' => $baseDir . '/api/src/models/ManualInputObservation.php',
    'Meteor' => $baseDir . '/api/src/models/Meteor.php',
    'MeteorAdminBoardController' => $baseDir . '/api/src/controllers/resourcecontrollers/MeteorAdminBoardController.php',
    'MeteorClassificationController' => $baseDir . '/api/src/controllers/resourcecontrollers/MeteorClassificationController.php',
    'MeteorDao' => $baseDir . '/api/src/dao/MeteorDao.php',
    'MeteorService' => $baseDir . '/api/src/service/MeteorService.php',
    'ObservationCamData' => $baseDir . '/api/src/models/ObservationCamData.php',
    'ObservationCamDataDao' => $baseDir . '/api/src/dao/ObservationCamDataDao.php',
    ...
    'Role' => $baseDir . '/api/src/models/Role.php',
    'Router' => $baseDir . '/api/src/controllers/Router.php',
    ...
    'Station' => $baseDir . '/api/src/models/Station.php',
    'StationDao' => $baseDir . '/api/src/dao/StationDao.php',
    'StationLogController' => $baseDir . '/api/src/controllers/resourcecontrollers/StationLogController.php',
    ...
    'User' => $baseDir . '/api/src/models/User.php',
    'UserController' => $baseDir . '/api/src/controllers/resourcecontrollers/UserController.php',
    'UserDao' => $baseDir . '/api/src/dao/UserDao.php',
    'UserListController' => $baseDir . '/api/src/controllers/resourcecontrollers/UserDetailsController.php',
    'UserLoginController' => $baseDir . '/api/src/controllers/resourcecontrollers/UserLoginController.php',
    'UserReview' => $baseDir . '/api/src/models/UserReview.php',
    'UserReviewDao' => $baseDir . '/api/src/dao/UserReviewDao.php',
    'UserService' => $baseDir . '/api/src/service/UserService.php',
);
