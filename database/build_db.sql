...
CREATE TABLE IF NOT EXISTS observation_cam_data (
  ...
  trail_positions FLOAT NULL DEFAULT NULL,
  trail_timestamps FLOAT NULL DEFAULT NULL,
  trail_coordinates FLOAT NULL DEFAULT NULL,
  trail_gnomonic FLOAT NULL DEFAULT NULL,
  trail_midpoint FLOAT NULL DEFAULT NULL,
  trail_arc FLOAT NULL DEFAULT NULL,
  trail_brightness INT(11) NULL DEFAULT NULL,
  trail_size INT(11) NULL DEFAULT NULL,
  trail_frame_brightness FLOAT NULL DEFAULT NULL,
