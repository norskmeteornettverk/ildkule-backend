...
/**
 * This script sets up the routing for between the incoming HTTP requests and various resource controllers such as 
 * such as for users and meteors. It uses Router (Based on the PHP Router https://phprouter.com/) to map routes to their controllers.
 */
...
$frontController->post(	'/api/insight/$reportname'              ,'/api/src/controllers/resourcecontrollers/InsightDashboardController.php'      ); # Get insight dashboard. Post is used for sending the filter parameters
...
$frontController->post(	'/api/mediaload'	                      ,'/api/src/controllers/resourcecontrollers/MediaLoadController.php'             ); # Load and create media content
