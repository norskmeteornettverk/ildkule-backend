...
class UserLoginController extends AbstractController
{
	...
	protected function post()
	{
		...
		if (dbNumRows($result) < 1) {
			...
			echo json_encode(array('message' => 'Innlogging utført!', 'token' => $jwt, 'accessToken' => $jwt, 'id' => $id, 'email' => 'test@test.com', 'username' => $username, 'user_role' => $role, 'roles' => [$role], 'user_level' => $user_level, 'tutorial_completed' => boolval($tutorial_completed), 'confirmed' => boolval($confirmed)));
		}
	}
